...
var BaseQuery = require('maguey').BaseQuery; // rst:affected
var FakeAdapter = require('./fake-adapter'); // rst:affected
...
exports.executed = function(chai, utils) {
  var Assertion = chai.Assertion;
  new Assertion(this._obj).to.be.instanceof(FakeAdapter.__class__);
 ...
 * @property clients
 */
exports.oneClient = function(chai, utils, statements) {
  var Assertion = chai.Assertion;
  new Assertion(this._obj).to.be.instanceof(FakeAdapter.__class__);
  new Assertion(this._obj).to.have.property('clients')
